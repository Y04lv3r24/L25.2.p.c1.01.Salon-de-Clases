...
let estudiante1: Cl_Estudiante = new Cl_Estudiante("Luis", 16, "M");
let estudiante2: Cl_Estudiante = new Cl_Estudiante("Ana", 19, "F");
let estudiante3: Cl_Estudiante = new Cl_Estudiante("José", 20, "M");
let estudiante4: Cl_Estudiante = new Cl_Estudiante("Carmen", 18, "F");

let salonClases: Cl_SalonClases = new Cl_SalonClases();
